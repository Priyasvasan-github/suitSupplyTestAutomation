...
public class HomePageActions {
    ...
    public boolean isHomePageLoaded(){
        return homePage.isHomePageBannerDisplayed();
    }
    ...
    public void navigateToCustomMadeOption(String menuOption){
        ...
        switch (menuOption.toUpperCase()){
            ...
            case CustomMadeMenuOptions.TROUSERS: homePage.clickTrouserOptionFromCustomMode(); break;
